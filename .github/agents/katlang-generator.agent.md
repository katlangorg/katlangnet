...
- Prefer direct multi-argument syntax when the items are already separate plain-call items: `order(3, 4, 2, 1)`, `contains(a, b, c, target)`, `first(a, b, c)`, `last(a, b, c)`, `distinct(a, b, a, c)`, `take(2, a, b, c)`, `skip(2, a, b, c)`, `sum(10, 20, 30)`, `reduce(1, 2, 3, Step, 0)`
