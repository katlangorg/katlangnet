...
- specification surface cases: 175
- excluded parse-level cases (Lean has no surface parser): 6
- excluded C#-only cases (each carries an explicit reason in the corpus): 2
- Lean-guarded cases: 167
- probe observations (C#-only by design): 268
...
def case_call_reentry_identity : Expr :=
  .algorithmExpr (alg [] [] [privateProp "I" (alg ["a"] [] [] [.param "a"]), privateProp "A" (alg [] [] [] [.num 1, .num 2, .num 3])] [.call (.resolve "I") [.call (.resolve "I") [.resolve "A"]]])
...
def case_select_spread_vs_capture_select : Expr :=
  .algorithmExpr (alg [] [] [privateProp "A" (alg [] [] [] [(.listLiteral [.listLiteral [.num 1, .num 2], .listLiteral [.num 3, .num 4]])])] [.sequenceSpread (.capture [.index (.resolve "A") (.num 0)]), .index (.capture [.sequenceSpread (.resolve "A")]) (.num 0)])
...
def case_decon_pair : Expr :=
  .algorithmExpr (alg [] [] [privateProp "d" (alg [] [] [] [.num 1, .num 2]), privateProp "x" (alg [] [] [] [.call (.algorithmExpr (algWithParameterPatterns [.sequenceValue [.capture { name := "x" }, .capture { name := "y" }]] [] [] [.param "x"])) [.resolve "d"]]), privateProp "y" (alg [] [] [] [.call (.algorithmExpr (algWithParameterPatterns [.sequenceValue [.capture { name := "x" }, .capture { name := "y" }]] [] [] [.param "y"])) [.resolve "d"]])] [.resolve "x", .resolve "y"])
...
def case_decon_collecting_tail : Expr :=
  .algorithmExpr (alg [] [] [privateProp "d" (alg [] [] [] [.num 1, .num 2, .num 3]), privateProp "rest" (alg [] [] [] [.call (.algorithmExpr (algWithParameterPatterns [.sequenceValue [.capture { name := "x" }, .capture { name := "rest", kind := .collecting }]] [] [] [.param "rest"])) [.resolve "d"]])] [.resolve "rest"])
...
def case_decon_collecting_head : Expr :=
  .algorithmExpr (alg [] [] [privateProp "d" (alg [] [] [] [.num 1, .num 2, .num 3]), privateProp "head" (alg [] [] [] [.call (.algorithmExpr (algWithParameterPatterns [.sequenceValue [.capture { name := "head", kind := .collecting }, .capture { name := "last" }]] [] [] [.param "head"])) [.resolve "d"]]), privateProp "last" (alg [] [] [] [.call (.algorithmExpr (algWithParameterPatterns [.sequenceValue [.capture { name := "head", kind := .collecting }, .capture { name := "last" }]] [] [] [.param "last"])) [.resolve "d"]])] [.resolve "head", .resolve "last"])
...
def case_decon_collecting_middle : Expr :=
  .algorithmExpr (alg [] [] [privateProp "d" (alg [] [] [] [.num 1, .num 2, .num 3, .num 4]), privateProp "middle" (alg [] [] [] [.call (.algorithmExpr (algWithParameterPatterns [.sequenceValue [.capture { name := "x" }, .capture { name := "middle", kind := .collecting }, .capture { name := "z" }]] [] [] [.param "middle"])) [.resolve "d"]])] [.resolve "middle"])
...
def case_decon_empty_collecting : Expr :=
  .algorithmExpr (alg [] [] [privateProp "d" (alg [] [] [] [.num 1]), privateProp "rest" (alg [] [] [] [.call (.algorithmExpr (algWithParameterPatterns [.sequenceValue [.capture { name := "x" }, .capture { name := "rest", kind := .collecting }]] [] [] [.param "rest"])) [.resolve "d"]]), privateProp "x" (alg [] [] [] [.call (.algorithmExpr (algWithParameterPatterns [.sequenceValue [.capture { name := "x" }, .capture { name := "rest", kind := .collecting }]] [] [] [.param "x"])) [.resolve "d"]])] [.resolve "rest", .resolve "x"])
...
def case_decon_arity_over : Expr :=
  .algorithmExpr (alg [] [] [privateProp "d" (alg [] [] [] [.num 1, .num 2, .num 3]), privateProp "x" (alg [] [] [] [.call (.algorithmExpr (algWithParameterPatterns [.sequenceValue [.capture { name := "x" }, .capture { name := "y" }]] [] [] [.param "x"])) [.resolve "d"]])] [.resolve "x"])
...
def case_decon_unpacks_stored_value : Expr :=
  .algorithmExpr (alg [] [] [privateProp "A" (alg [] [] [] [.num 1, .num 2, .num 3]), privateProp "d" (alg [] [] [] [.resolve "A"]), privateProp "y" (alg [] [] [] [.call (.algorithmExpr (algWithParameterPatterns [.sequenceValue [.capture { name := "x" }, .capture { name := "y" }, .capture { name := "z" }]] [] [] [.param "y"])) [.resolve "d"]])] [.resolve "y"])
...
def case_decon_tutorial_full : Expr :=
  .algorithmExpr (alg [] [] [privateProp "A" (alg [] [] [] [.num 1, .num 2, .num 3, .num 4, .num 5]), privateProp "d" (alg [] [] [] [.resolve "A"]), privateProp "x" (alg [] [] [] [.call (.algorithmExpr (algWithParameterPatterns [.sequenceValue [.capture { name := "x" }, .capture { name := "y", kind := .collecting }, .capture { name := "z" }]] [] [] [.param "x"])) [.resolve "d"]]), privateProp "y" (alg [] [] [] [.call (.algorithmExpr (algWithParameterPatterns [.sequenceValue [.capture { name := "x" }, .capture { name := "y", kind := .collecting }, .capture { name := "z" }]] [] [] [.param "y"])) [.resolve "d"]]), privateProp "z" (alg [] [] [] [.call (.algorithmExpr (algWithParameterPatterns [.sequenceValue [.capture { name := "x" }, .capture { name := "y", kind := .collecting }, .capture { name := "z" }]] [] [] [.param "z"])) [.resolve "d"]])] [.resolve "x", .resolve "y", .resolve "z"])
...
def case_decon_lone_collecting : Expr :=
  .algorithmExpr (alg [] [] [privateProp "d" (alg [] [] [] [.num 1, .num 2, .num 3]), privateProp "all" (alg [] [] [] [.call (.algorithmExpr (algWithParameterPatterns [.sequenceValue [.capture { name := "all", kind := .collecting }]] [] [] [.param "all"])) [.resolve "d"]])] [.resolve "all"])
...
def case_variadic_nested_not_flattened : Expr :=
  .algorithmExpr (alg [] [] [privateProp "Arg" (alg [] [] [] [(.capture [.num 1, .num 2]), (.capture [.num 3, .num 4])]), privateProp "Many" (algWithParameters [{ name := "values", kind := .collecting }] [] [] [.dotCall (.param "values") "count" none]), privateProp "Flattened" (alg [] [] [] [.dotCall (.call (.resolve "atoms") [.resolve "Arg"]) "count" none])] [.call (.resolve "Many") [.sequenceSpread (.resolve "Arg")], .resolve "Flattened"])
...
def case_call_spread_into_conditional_clauses : Expr :=
  .algorithmExpr (alg [] [] [privateProp "F" (.conditional none [] [⟨.sequenceValue [.litInt 0, .litInt 0], alg [] [] [] [.num 100]⟩, ⟨.sequenceValue [.bind "x", .bind "y"], alg [] [] [] [.binary .add (.param "x") (.param "y")]⟩]), privateProp "A" (alg [] [] [] [(.capture [.num 1, .num 2])])] [.call (.resolve "F") [.sequenceSpread (.resolve "A")]])
...
def case_call_spread_dispatches_before_clause_selection : Expr :=
  .algorithmExpr (alg [] [] [privateProp "F" (.conditional none [] [⟨.sequenceValue [.litInt 0, .litInt 0], alg [] [] [] [.num 100]⟩, ⟨.sequenceValue [.bind "x", .bind "y"], alg [] [] [] [.binary .add (.param "x") (.param "y")]⟩]), privateProp "A" (alg [] [] [] [(.capture [.num 0, .num 0])])] [.call (.resolve "F") [.sequenceSpread (.resolve "A")]])
...
def case_call_spread_into_patterned_callee : Expr :=
  .algorithmExpr (alg [] [] [privateProp "F" (algWithParameters [{ name := "x" }, { name := "x" }] [] [] [.binary .add (.param "x") (.num 1)]), privateProp "A" (alg [] [] [] [(.capture [.num 7, .num 7])])] [.call (.resolve "F") [.sequenceSpread (.resolve "A")]])
...
def case_callback_mixed_variadic_rows : Expr :=
  .algorithmExpr (alg [] [] [privateProp "F" (algWithParameters [{ name := "first" }, { name := "middle", kind := .collecting }, { name := "last" }] [] [] [.param "middle"]), privateProp "Rows" (alg [] [] [] [(.listLiteral [.capture [.num 1, .num 2, .num 3, .num 4]])])] [.dotCall (.resolve "Rows") "map" (some [.resolve "F"])])
...
def case_reduce_accumulates_value : Expr :=
  .algorithmExpr (alg [] [] [privateProp "Append" (algWithParameters [{ name := "item" }, { name := "history", kind := .collecting }] [] [] [(.capture [.sequenceSpread (.param "history"), .param "item"])])] [.call (.resolve "reduce") [(.capture [.num 2, .num 3, .num 4]), .resolve "Append", .num 1]])
...
def case_reduce_empty_initial_is_one_value : Expr :=
  .algorithmExpr (alg [] [] [privateProp "R" (alg ["x", "acc"] [] [] [.binary .add (.param "acc") (.param "x")]), privateProp "Init" (alg [] [] [] [.num 1, .num 2])] [.call (.resolve "reduce") [(.emptySequence 0), .resolve "R", .resolve "Init"]])
...
def case_spread_binds_before_list : Expr :=
  .algorithmExpr (alg [] [] [privateProp "X" (algWithParameters [{ name := "vals", kind := .collecting }] [] [] [.dotCall (.param "vals") "count" none]), privateProp "b" (alg [] [] [] [(.capture [.num 1, .num 2])])] [.call (.resolve "X") [.num 7, .sequenceSpread (.resolve "b")]])
...
def case_list_call_boundary : Expr :=
  .algorithmExpr (alg [] [] [privateProp "F" (alg ["a", "b", "c"] [] [] [.binary .add (.binary .add (.param "a") (.param "b")) (.param "c")]), privateProp "One" (alg ["x"] [] [] [.num 7]), privateProp "A" (alg [] [] [] [(.listLiteral [.num 1, .num 2, .num 3])])] [.call (.resolve "One") [.resolve "A"], .call (.resolve "F") [.sequenceSpread (.resolve "A")]])
...
def case_list_lone_deconstruction : Expr :=
  .algorithmExpr (alg [] [] [privateProp "d" (alg [] [] [] [(.listLiteral [.num 1, .num 2, .num 3])]), privateProp "x" (alg [] [] [] [.call (.algorithmExpr (algWithParameterPatterns [.sequenceValue [.capture { name := "x" }, .capture { name := "y" }, .capture { name := "z" }]] [] [] [.param "x"])) [.resolve "d"]]), privateProp "y" (alg [] [] [] [.call (.algorithmExpr (algWithParameterPatterns [.sequenceValue [.capture { name := "x" }, .capture { name := "y" }, .capture { name := "z" }]] [] [] [.param "y"])) [.resolve "d"]]), privateProp "z" (alg [] [] [] [.call (.algorithmExpr (algWithParameterPatterns [.sequenceValue [.capture { name := "x" }, .capture { name := "y" }, .capture { name := "z" }]] [] [] [.param "z"])) [.resolve "d"]])] [.resolve "x", .resolve "y", .resolve "z"])
...
def case_list_deconstruction_not_recursive : Expr :=
  .algorithmExpr (alg [] [] [privateProp "d" (alg [] [] [] [(.listLiteral [.listLiteral [.num 1, .num 2], .num 3])]), privateProp "x" (alg [] [] [] [.call (.algorithmExpr (algWithParameterPatterns [.sequenceValue [.capture { name := "x" }, .capture { name := "y" }]] [] [] [.param "x"])) [.resolve "d"]]), privateProp "y" (alg [] [] [] [.call (.algorithmExpr (algWithParameterPatterns [.sequenceValue [.capture { name := "x" }, .capture { name := "y" }]] [] [] [.param "y"])) [.resolve "d"]])] [.resolve "x", .resolve "y"])
...
def case_collecting_binding_exact_list : Expr :=
  .algorithmExpr (alg [] [] [privateProp "d" (alg [] [] [] [(.listLiteral [.num 1, .num 2, .num 3])]), privateProp "x" (alg [] [] [] [.call (.algorithmExpr (algWithParameterPatterns [.sequenceValue [.capture { name := "x" }, .capture { name := "rest", kind := .collecting }]] [] [] [.param "x"])) [.resolve "d"]]), privateProp "rest" (alg [] [] [] [.call (.algorithmExpr (algWithParameterPatterns [.sequenceValue [.capture { name := "x" }, .capture { name := "rest", kind := .collecting }]] [] [] [.param "rest"])) [.resolve "d"]])] [.resolve "x", .resolve "rest"])
...
def case_list_lone_collecting_assignment : Expr :=
  .algorithmExpr (alg [] [] [privateProp "d" (alg [] [] [] [(.listLiteral [.num 1, .num 2, .num 3])]), privateProp "items" (alg [] [] [] [.call (.algorithmExpr (algWithParameterPatterns [.sequenceValue [.capture { name := "items", kind := .collecting }]] [] [] [.param "items"])) [.resolve "d"]])] [.resolve "items"])
