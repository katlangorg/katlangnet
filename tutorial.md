...
- [KatLang Tutorial](#katlang-tutorial)
  - [Contents](#contents)
  - [What KatLang Is](#what-katlang-is)
  - [Your First KatLang Program](#your-first-katlang-program)
    - [Comments](#comments)
  - [Values and Arithmetic](#values-and-arithmetic)
  ...
  - [Higher-Order Algorithms](#higher-order-algorithms)
    - [Algorithm as Argument](#algorithm-as-argument)
    - [`{}` vs `()`](#-vs-)
  - [Structural Composition with `;`](#structural-composition-with-)
  - [Atoms](#atoms)
  - [Conditional Algorithms (`when`)](#conditional-algorithms-when)
  ...
  - [Loading and `open`](#loading-and-open)
