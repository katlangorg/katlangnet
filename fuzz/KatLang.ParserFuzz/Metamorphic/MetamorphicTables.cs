...
internal enum MetamorphicWrapperProjection
{
    ...
    /// <summary>`MmWrap(*xs) = ...` — a collecting parameter, making the wrapper variadic. Never equivalent; always rejected.</summary>
    Collecting,
...
/// admitted. Combinations that were measured NOT to agree — collecting-parameter and arity-mismatched
