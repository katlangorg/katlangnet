...
internal static class Utf16Tables
{
    ...
    [
        new(Utf16TemplateIds.IdentifierStart, "A = 1\n", "A", ClosedWhenBenign: false),
        new(Utf16TemplateIds.IdentifierContinue, "A = 1\nA", "", ClosedWhenBenign: false),
        new(Utf16TemplateIds.PropertyName, "", " = 1\n1", ClosedWhenBenign: false),
        new(Utf16TemplateIds.FunctionName, "", "(x) = x\n1", ClosedWhenBenign: false),
        new(Utf16TemplateIds.ParameterName, "F(", ") = 1\nF(2)", ClosedWhenBenign: false),
        new(Utf16TemplateIds.NumberBoundary, "12", "34", ClosedWhenBenign: false),
        new(Utf16TemplateIds.StringLiteral, "'", "'", ClosedWhenBenign: true, StringBridge: true),
        new(Utf16TemplateIds.StringBackslash, "'a\\", "b'", ClosedWhenBenign: true, StringBridge: true),
        new(Utf16TemplateIds.StringUnterminated, "'a", "\nB = 2", ClosedWhenBenign: false),
        new(Utf16TemplateIds.LineComment, "// ", "\n1", ClosedWhenBenign: true),
        new(Utf16TemplateIds.CommentAtEof, "1\n// ", "", ClosedWhenBenign: false),
        new(Utf16TemplateIds.DelimiterAdjacent, "(1, ", "2)", ClosedWhenBenign: false),
        new(Utf16TemplateIds.DottedCall, "A = (1, 2)\nA.", "count", ClosedWhenBenign: false),
        new(Utf16TemplateIds.SpreadOperator, "A = (1, 2)\nA", "*", ClosedWhenBenign: false),
        new(Utf16TemplateIds.ListLiteral, "[1, ", "2]", ClosedWhenBenign: false),
        new(Utf16TemplateIds.SequenceLiteral, "(1, ", "2)", ClosedWhenBenign: false),
        new(Utf16TemplateIds.Deconstruction, "x, ", ", z = (1, 2, 3)\nx", ClosedWhenBenign: false),
        new(Utf16TemplateIds.CollectingBinding, "F(a, *", "z) = a\nF(1, 2)", ClosedWhenBenign: false),
        new(Utf16TemplateIds.CallbackBody, "F(x) = x + ", "\n[1, 2].map(F)", ClosedWhenBenign: false),
        new(Utf16TemplateIds.ConditionalClause, "F(0) = 1\nF(", ") = 2\nF(0)", ClosedWhenBenign: false),
        new(Utf16TemplateIds.MultilineBody, "A = 1 +\n", "\nA", ClosedWhenBenign: false),
        new(Utf16TemplateIds.RecoveryPoint, "(1, ", "", ClosedWhenBenign: false),
        new(Utf16TemplateIds.EofBoundary, "1\n", "", ClosedWhenBenign: false),
